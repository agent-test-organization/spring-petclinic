...
/**
 * Controller for pet analytics features.
 * Provides both web views and REST API endpoints to test the PetAnalyticsService.
 */
@Controller
public class PetAnalyticsController {
    ...
    /**
     * Web page to display analytics dashboard
    ...
    /**
     * REST API endpoint for analytics data
     * Visit: http://localhost:8080/api/analytics
     */
    ...
    /**
     * REST API endpoint for individual pet report
     * Visit: http://localhost:8080/api/pets/{petId}/report
     */
    ...
    /**
     * Web page to show individual pet reports
     * Visit: http://localhost:8080/owners/{ownerId}/pets/{petId}/analytics
     */
