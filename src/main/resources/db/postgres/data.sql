...
INSERT INTO owners (first_name, middle_name, last_name, address, city, telephone) SELECT 'George', 'Washington', 'Franklin', '110 W. Liberty St.', 'Madison', '6085551023' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=1);
INSERT INTO owners (first_name, middle_name, last_name, address, city, telephone) SELECT 'Betty', NULL, 'Davis', '638 Cardinal Ave.', 'Sun Prairie', '6085551749' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=2);
INSERT INTO owners (first_name, middle_name, last_name, address, city, telephone) SELECT 'Eduardo', 'Miguel', 'Rodriquez', '2693 Commerce St.', 'McFarland', '6085558763' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=3);
INSERT INTO owners (first_name, middle_name, last_name, address, city, telephone) SELECT 'Harold', NULL, 'Davis', '563 Friendly St.', 'Windsor', '6085553198' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=4);
INSERT INTO owners (first_name, middle_name, last_name, address, city, telephone) SELECT 'Peter', 'James', 'McTavish', '2387 S. Fair Way', 'Madison', '6085552765' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=5);
INSERT INTO owners (first_name, middle_name, last_name, address, city, telephone) SELECT 'Jean', NULL, 'Coleman', '105 N. Lake St.', 'Monona', '6085552654' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=6);
INSERT INTO owners (first_name, middle_name, last_name, address, city, telephone) SELECT 'Jeff', 'Robert', 'Black', '1450 Oak Blvd.', 'Monona', '6085555387' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=7);
INSERT INTO owners (first_name, middle_name, last_name, address, city, telephone) SELECT 'Maria', NULL, 'Escobito', '345 Maple St.', 'Madison', '6085557683' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=8);
INSERT INTO owners (first_name, middle_name, last_name, address, city, telephone) SELECT 'David', 'Michael', 'Schroeder', '2749 Blackhawk Trail', 'Madison', '6085559435' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=9);
INSERT INTO owners (first_name, middle_name, last_name, address, city, telephone) SELECT 'Carlos', NULL, 'Estaban', '2335 Independence La.', 'Waunakee', '6085555487' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=10);
